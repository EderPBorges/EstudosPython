...
class TarefeNaoEncontrada(Exception):
    pass
...
class Projeto:
    ...
    def procurar(self, descricao):
        try:
            ...
            raise TarefeNaoEncontrada(str(e))
...
def main():
    ...
    except TarefeNaoEncontrada as e:
